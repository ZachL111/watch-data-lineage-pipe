"""Regression checks for the watch-data-lineage-pipe casebook."""
...
from casebook.harness import assert_expected, watch_data_lineage_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_data_lineage_pipe_summary(), assert_expected())
